(()=>{
  ...
  const en={
    ...
    projectKicker:'YOUR IDEA, TURNED INTO A SYSTEM',projectTitleAccent:'DONBEX designs the path to build it.',projectIntro:'You do not need technical language. Tell us what you want to improve, automate or create; we organize the idea and turn it into a clear digital proposal.',
    projectStep1Label:'01 · UNDERSTAND',projectStep1Title:'Your business',projectStep1Text:'We understand how your business works today, where the friction is and what result you want to achieve.',
    projectStep2Label:'02 · DEFINE',projectStep2Title:'The solution',projectStep2Text:'We turn your need into a concrete solution: what it should do, who it serves and which process it should simplify.',
    projectStep3Label:'03 · DESIGN',projectStep3Title:'The experience',projectStep3Text:'We design the experience, flows and connections so the system feels intuitive, useful and scalable.',
    projectStep4Label:'04 · CONTINUE',projectStep4Title:'The next step',projectStep4Text:'We review the scope and contact you with the next step to turn the idea into an executable project.',
  ...
  function typingThen(text,cb){const d=document.createElement('div');d.className='msg bot typing';d.innerHTML='<i></i><i></i><i></i>';msgs?.appendChild(d);msgs.scrollTop=msgs.scrollHeight;setTimeout(()=>{d.remove();addMsg(text);cb?.()},2200)}
